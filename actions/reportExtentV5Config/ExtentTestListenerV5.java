...
import static reportExtentV5Config.ExtentTestManager.getTest;
...
public class ExtentTestListenerV5  extends BaseTest implements ITestListener {
	...
	public void onStart(ITestContext iTestContext) {
		iTestContext.setAttribute("WebDriver", this.getInstance());
	}
	...
	public void onTestFailure(ITestResult iTestResult) {
		...
		WebDriver driver = ((BaseTest) testClass).getInstance();
