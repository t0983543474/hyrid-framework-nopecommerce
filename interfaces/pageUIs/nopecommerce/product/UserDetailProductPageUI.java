...
public class UserDetailProductPageUI {
	...
	public static final String WISHLIST_BTN = "css=.add-to-wishlist";
	public static final String MESSAGE_ADD_WISHLIST_SUCCESS = "css=p.content";
	public static final String WISHLIST_LINK = "xpath=//a[text()='wishlist']";
	public static final String PRODUCT_NAME = "css=.product-name h1";
	public static final String PROCESSOR_DROPDOW = "css=select#product_attribute_1";
	public static final String RAM_DROPDOW = "css=select#product_attribute_2";
